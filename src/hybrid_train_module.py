...
from model_ab import Wrand, Wrelation, Wmeta, HybridGNN
from utils import *
...
def train_model(graph, graph_by_type, args):
    ...
    if args.ab == 1:
        model = Wrelation(max_users=num_nodes, edge_type_count=args.edge_type_count, schema=args.schema, edge_dim=args.edge_dim,
                          input_dim=args.dimensions, output_dim=args.dimensions, random_layer=args.random_sample_layers)
    elif args.ab == 2:
        model = Wmeta(max_users=num_nodes, edge_type_count=args.edge_type_count, schema=args.schema, edge_dim=args.edge_dim,
                          input_dim=args.dimensions, output_dim=args.dimensions, random_layer=args.random_sample_layers)
    elif args.ab ==3:
        model = Wrand(max_users=num_nodes, edge_type_count=args.edge_type_count, schema=args.schema, edge_dim=args.edge_dim,
                          input_dim=args.dimensions, output_dim=args.dimensions, random_layer=args.random_sample_layers)
    else:
